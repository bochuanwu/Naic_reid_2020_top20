...
from .backbones.cls_hrnet import get_hr_net
...
class Backbone(nn.Module):
    def __init__(self, num_classes, cfg):
        ...
        if model_name == 'resnet50':
            ...
            self.in_planes = 2048
            self.base = get_hr_net(num_classes= num_classes,last_stride=last_stride, model_path = model_path)            

        else:
            print('unsupported backbone! but got {}'.format(model_name))

        if pretrain_choice == 'imagenet' and  model_name != 'HRnet':
