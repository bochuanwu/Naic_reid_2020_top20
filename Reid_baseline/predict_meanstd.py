...
if __name__ == '__main__':
    img_dir =  '../NAIC_Person_Reid/reid_baseline/dataset/train/images/'
    train_imgfilenames = glob.glob(img_dir+'*.png')
    img_dir =  '../NAIC_Person_Reid/reid_baseline/dataset/image_A/query/'
    query_imgfilenames = glob.glob(img_dir+'*.png')
    img_dir =  '../NAIC_Person_Reid/reid_baseline/dataset/2019_first/train/'
    ...
    train_sa_index = [i for i, v in enumerate(train_hist_labels) if (v == train_unique_hist_labels[0]) or (v == train_unique_hist_labels[1])]
    ...
    query_sa_index = [i for i, v in enumerate(query_hist_labels) if (v == query_unique_hist_labels[0]) or (v == query_unique_hist_labels[1])]
    ...
    gallery_sa_index = [i for i, v in enumerate(gallery_hist_labels) if (v == gallery_unique_hist_labels[0]) or (v == gallery_unique_hist_labels[1])]
